	...
	defer func() {
		...
		if err != nil {
			...
			case PatchException:
				...
				log.Println(console.Yellow(errStr.script))
				log.Print(console.Green("↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓"))
				log.Println(console.Red(errStr.excption.Error()))
				log.Print(console.Green("=================================================== PATCH-ERROR ==================================================="))
			case error:
				log.Print(console.Green("=================================================== PATCH-ERROR ==================================================="))
				log.Println(console.Red(errStr.Error()))
				log.Print(console.Green("=================================================== PATCH-ERROR ==================================================="))
			default:
				log.Print(console.Green("=================================================== PATCH-ERROR ==================================================="))
...
func (dm *DataMigrator) ExecSql(db *gorm.DB, script string) error {
	if err := db.Exec(script).Error; err != nil {
		log.Print(console.Green("=================================================== PATCH-ERROR ==================================================="))
		log.Println(console.Yellow(script))
		log.Print(console.Green("↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓"))
		log.Println(console.Red(err.Error()))
		log.Print(console.Green("=================================================== PATCH-ERROR ==================================================="))
...
func (dm *DataMigrator) ExecSqlFile(db *gorm.DB, filePath string) error {
	...
	for i := 0; i < len(sqlList)-1; i++ {
		...
		if err = db.Exec(sql).Error; err != nil {
			log.Print(console.Green("=================================================== PATCH-ERROR ==================================================="))
			log.Println(console.Yellow(sql))
			log.Print(console.Green("↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓"))
			log.Println(console.Red(err.Error()))
			log.Print(console.Green("=================================================== PATCH-ERROR ==================================================="))
			if !strings.Contains(err.Error(), "Query was empty") {
